...
const chaptersData: Chapter[] = [
  {
    ...
    exercises: [
      { id: 101, name: 'Exercise 1: Make the number 21 using blocks.', stars: 2 },
      { id: 102, name: 'Exercise 2: Make the number 35 using blocks.', stars: 5 },
      { id: 103, name: 'Exercise 3: Make the number 215 using blocks.', stars: 3},
    ],
  },
  {
    id: 2,
    ...
    exercises: [
      { id: 201, name: 'Exercise 1: Make the number 21 using blocks.', stars: 0 },
      { id: 202, name: 'Exercise 2: Make the number 35 using blocks.', stars: 0 },
    ],
  },
  {
    id: 3,
...
export default function ChaptersScreen() {
  ...
  const handleProgressBarLayout = (e: LayoutChangeEvent) => {
    const dimension = isLandscape ? e.nativeEvent.layout.height : e.nativeEvent.layout.width;
  ...
  return (
    <BackgroundWrapper>
      ...
      <ReturnButton />
        <View style={[styles.contentWrapper, isLandscape ? styles.landscape : styles.portrait]}>
          <View
            style={[
              styles.progressBarContainer,
              isLandscape ? styles.progressBarVertical : styles.progressBarHorizontal,
            ]}
